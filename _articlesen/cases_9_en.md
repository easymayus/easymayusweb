...
title: "In 2018, Easymay launched another Campus Visits, visited 30 well-known schools across the US"
title_short: 易美再度启程校园行，历时3月遍访美国30所名校
use_short_title: nan
description: Easymay, as the exclusive sponsor in education counseling and advising, has been invited to participate in Liaoyuan North America University Tour from February to April. Easymay team visited about 30 universities to take a deep observation on their admissions process and campus lives. Easymay team closely talked to students and answered questions from students regarding their academic planning and career research.
year: 2018
---
...
<meta name="format-detection" content="telephone=no">
  ...
  <meta property="twitter:description" content="独家留学咨询服务类企业，把握一手资讯，开拓美国本土教育资源，最具公信力的高端品牌" />
        ...
        <script nonce="511634213" type="text/javascript">
            window.logs = {
                pagetime: {}
            };
...
(function() {
	...
	function _addVConsole(uri, cb) {
		...
		node.src = uri;
		node.setAttribute('nonce', '511634213');
		if (cb) {
			node.onload = cb;
		}
...
var t="1566592641",n="1525914057",s="2018-05-10";
...
<script nonce="511634213" type="text/javascript">
    ...
    var img_format = 'jpeg';
    var srcid = '';
    var req_id = '2404erosiAIwFxo2dIHWiGm0';
    var networkType;
...
}(WX_BJ_REPORT),__moonf__(); }, 25);</script><script nonce="511634213" type="text/javascript">
