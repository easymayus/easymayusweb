...
(function($) {
    ...
    /* --------------------------- Video Play and Pause --------------------- */
    /* ---------------------------------------------------------------------- */
    $(".hover-link-video").click(function() {
        var dataTarget = $(this).attr("data-target");
        $(dataTarget).find(".video-html5").get(0).play();
    });

    $(".close, .modal").click(function() {
        $(".modal.in").find(".video-html5").get(0).pause();
    });
    ...
    /* --------------------------- Filter and Trigger Click ----------------- */
    /* ---------------------------------------------------------------------- */
    $(".raking-filter .rakingf_1_20").click(function() {
        $(".pagination .page").first().find("a").trigger("click");
    });

    $(".raking-filter .rakingf_21_40").click(function() {
        $(".pagination .page:nth-child(3)").find("a").trigger("click");
    });

    $(".raking-filter .rakingf_21_40").click(function() {
        $(".pagination .page:nth-child(4)").find("a").trigger("click");
    });

    $(".raking-filter .rakingf_41_60").click(function() {
        $(".pagination .page:nth-child(5)").find("a").trigger("click");
    });

    $(".raking-filter .rakingf_61_80").click(function() {
        $(".pagination .page:nth-child(6)").find("a").trigger("click");
    });

    $(".raking-filter .rakingf_81_100").click(function() {
        $(".pagination .page:nth-child(7)").find("a").trigger("click");
    });
    ...
    /* Scroll Top Effect */
    $('a.btn[href^="#"], .qbutton, .professions-info .project-caption a').bind('click', function(e) {
        e.preventDefault();
    ...
    var rev_slider_about = $(".rev_slider_about");
    $(window).scroll(function() {
        var scroll = $(window).scrollTop();

        if (scroll >= 60) {
            rev_slider_about.removeClass('highlitedcontents').addClass("clearcontents");
        } else {
            rev_slider_about.removeClass("clearcontents").addClass('highlitedcontents');
        }
    });
    ...
    THEMEMASCOT.header = {
        ...
        TM_scroolToTopOnClick: function() {
            ...
            $document_body.on('click', '.scrollToTopFunctionOnly', function(e) {
                $('html, body').animate({
                    scrollTop: 0
                }, 800);
                return false;
    ...
    THEMEMASCOT.slider = {
        ...
        TM_owlCarousel: function() {
            ...
            var $owl_carousel_3col_no_auto_play = $('.owl-carousel-3col-noAutoPlay');
            if ($owl_carousel_3col_no_auto_play.length > 0) {
                if (!$owl_carousel_3col_no_auto_play.hasClass("owl-carousel")) {
                    $owl_carousel_3col_no_auto_play.addClass("owl-carousel owl-theme");
                }
                $owl_carousel_3col_no_auto_play.each(function() {
                    var data_dots = ($(this).data("dots") === undefined) ? false : $(this).data("dots");
                    var data_nav = ($(this).data("nav") === undefined) ? false : $(this).data("nav");
                    var data_duration = ($(this).data("duration") === undefined) ? 4000 : $(this).data("duration");
                    $(this).owlCarousel({
