...
<meta name="format-detection" content="telephone=no">
  ...
  <meta property="twitter:description" content="我们远道而来，只为给你呈现最权威最专业的申请讯息，帮你的名校梦扬帆起航！" />
        ...
        <script nonce="236919746" type="text/javascript">
            window.logs = {
                pagetime: {}
            };
...
(function() {
	...
	function _addVConsole(uri, cb) {
		...
		node.src = uri;
		node.setAttribute('nonce', '236919746');
		if (cb) {
			node.onload = cb;
		}
...
var t="1576610985",n="1568854800",s="2019-09-19";
...
<script nonce="236919746" type="text/javascript">
    ...
    var img_format = 'jpeg';
    var srcid = '';
    var req_id = '1803M5SWCPVVVp9I7tkZUvCM';
    var networkType;
...
}(WX_BJ_REPORT),window.WX_BJ_REPORT=WX_BJ_REPORT,__moonf__(); }, 25);</script><script nonce="236919746" type="text/javascript">
